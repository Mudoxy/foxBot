...
class SQLighter:
    ...
    def __init__(self, database : str):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS {} ("\
                            ...
                            "chat_id integer, begin_date datetime default current_timestamp;".format(self.name))


    def read_by_id(self, chat_id: int, message_id: int):
        with self.connection:
            return self.cursor.execute("SELECT * FROM {} WHERE  message_id = '{}';".format(self.name, message_id)).fetchall()
